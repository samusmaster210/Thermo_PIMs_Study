...
# Output directory
output_dir = "Excel_Ridge_Bayes_Results"
...
# Save best alpha
pd.DataFrame({"Best Alpha": [best_alpha]}).to_csv(os.path.join(output_dir, "Ridge_best_alpha.csv"), index=False)
...
cv_df.to_csv(os.path.join(output_dir, "Ridge_cv_results.csv"), index=False)
